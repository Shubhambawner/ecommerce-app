export default function(){
    ...
    <div className="container">
        ...
        <p>Last Revised: 2021-05-14 04:53:47</p>
        <h3>&nbsp;</h3>
        <h3>1. OVERVIEW</h3>
        <p>This Terms of Service Agreement (“Agreement”) is entered into by and between IIITprep, registered address Akola, India (“Company”) and you, and is made effective as of the date of your use of this website https://iiitprep.com (“iiitprep.com”) or the date of electronic acceptance.</p>
        <p>This Agreement sets forth the general terms and conditions of your use of the http://iiitprep.com as well as the products and/or services purchased or accessed through this Site (the “Services”).</p>
        ...
        <p>In addition to the general rules above, the provisions in this Section apply specifically to your use of Companies Content posted to Site. Companies Content on this Site, including without limitation the text, software, scripts, source code, API, graphics, photos, sounds, music, videos and interactive features and the trademarks, service marks and logos contained therein (“Companies Content”), are owned by or licensed to IIITprep in perpetuity, and are subject to copyright, trademark, and/or patent protection.</p>
        ...
        <p>You acknowledge and agree that your payment will be charged and processed by IIITprep.</p>
        ...
        <p>Refund Policy: for products and services eligible for a refund, you may request a refund under the terms and conditions of our Refund Policy which can be accessed&nbsp;<a href="https://iiitprep.com/refund-policy/index.html" target="_blank">here.</a></p>
        <h3>&nbsp;</h3>
        ...
        <p>IIITprep</p>
        <p>7972348944 | info@iiitprep.com</p>
    </div>
</section>
}
